...
public class PurchaseRequisitionBean extends Page implements Serializable {
     ...
     * 业务使用 数量字符串
     */
    private String purchaseRequisitionNumbers;
    ...
    public String getPurchaseRequisitionNumbers() {
        return purchaseRequisitionNumbers;
    }

    public void setPurchaseRequisitionNumbers(String purchaseRequisitionNumbers) {
        this.purchaseRequisitionNumbers = purchaseRequisitionNumbers;
    }

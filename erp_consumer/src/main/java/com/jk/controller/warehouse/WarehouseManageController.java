...
public class WarehouseManageController {
    ...
    @ResponseBody
    public ResultPage queryListStock(Integer page, Integer rows, Indents indents){
        ResultPage resultPage = warehouseManageService.queryListStock(page, rows,indents);
        return resultPage;
    }
}
